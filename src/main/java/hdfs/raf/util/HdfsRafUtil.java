...
public class HdfsRafUtil {

  private static final Logger LOGGER = LoggerFactory.getLogger(HdfsRafUtil.class);
  ...
  public static void createLocalSparseFile(File file, long length) throws IOException {
    HdfsRafUtil.exec(LOGGER, Level.INFO, "dd", "if=/dev/zero", "of=" + file.getCanonicalPath(), "bs=1", "count=0",
        "seek=" + length);
  }
